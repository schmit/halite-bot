...
Square = namedtuple('Square', 'x y owner strength production data')
...
class GameMap:
    ...
    def neighbors(self, square, n=1, include_self=False):
        ...
        For single-step neighbors,
        the enumeration index provides the
        direction associated with the neighbor.
        """
    ...
    def get_square(self, coords):
        x, y = coords
        return self.contents[square.y][square.x]
